...
# ============================================================
# LOGOUT PROTECTION (CRITICAL FIX)
# ============================================================
...
def extract_links(page_url: str, html: str) -> List[str]:
    ...
    for a in soup.find_all("a"):
        ...
        # CRITICAL FIX: DO NOT VISIT LOGOUT
        if _is_logout_url(u):
            continue
...
def crawl_site(
    ...
    while queue and len(visited) < max_pages:
        ...
        # CRITICAL FIX: DO NOT PROCESS LOGOUT REDIRECTS
        if _is_logout_url(final_url):
            continue
        ...
        for spec_url in spec_urls:
            ...
            try:
                ...
                openapi_targets.extend(

                    parse_openapi_targets(final_url, spec)
    ...
    return {
        ...
        "query_urls": sorted(discovered_query_urls),
